...
|---       |---                                             |---              |
|owner     |The public key of the owner                     | Binary            | 
|target    |An address that this DataItem is being sent to  | Binary            | 
|nonce     |A value to prevent replay attacks               | Binary            |
|tags      |An array of tag objects                         | Binary      |
|data      |The data contents                               | Binary            |                  
|signature |A signature produced by owner                   | Binary            |  
|id        |The id the item                                 | Binary            |
