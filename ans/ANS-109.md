...
One example of abstractions and safeguards built on top of such a system could be a "VerifiersDAO" - a community that specifies which human "Verifiers" or "Verification Services" can vouch for others. 
